...
class Avatars():
    ...
    def get_picture_url(self, page_url, filename):
        ...
        picture_urls = xml.xpath('//div[@class="avatar-thumb"]/a/@href')
        for i in range(0, len(picture_urls) + 1):
            try:
                picture_xml = self.get_xml(picture_urls[i])
                picture = picture_xml.xpath('//*[@id="page_container"]/div[3]/a/img/@src')
    ...
    def get_page_url(self):
        ...
        max_page = int(xml.xpath('//*[@id="page_container"]/div[9]/div[1]/ul/li/a/text()')[-2])
